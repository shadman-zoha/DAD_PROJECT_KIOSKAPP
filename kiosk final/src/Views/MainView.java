...
public class MainView extends JFrame {
	...
	private ItemDB  itemProductDatabase = new ItemDB();
	...
	public MainView() {
		...
		JButton btnNewButton = new JButton("Touch to Order");
		btnNewButton.setForeground(Color.RED);
		btnNewButton.setFont(new Font("Gill Sans MT Condensed", Font.BOLD, 30));
		...
		btnNewButton.setBounds(207, 371, 316, 35);
		...
		lblNewLabel.setBounds(235, 92, 225, 213);
		lblNewLabel.setVerticalAlignment(SwingConstants.BOTTOM);
		lblNewLabel.setIcon(new ImageIcon(MainView.class.getResource("/images/burger king.png")));
		panel.add(lblNewLabel);
		
		JLabel lblNewLabel_1 = new JLabel("Welcome to Burger King");
		lblNewLabel_1.setHorizontalAlignment(SwingConstants.CENTER);
		lblNewLabel_1.setBackground(Color.WHITE);
		lblNewLabel_1.setFont(new Font("Gill Sans MT Condensed", Font.BOLD, 31));
		lblNewLabel_1.setForeground(Color.RED);
		lblNewLabel_1.setBounds(207, 11, 299, 42);
		panel.add(lblNewLabel_1);
		
		JPanel panel_1 = new JPanel();
		panel_1.setBorder(new LineBorder(new Color(0, 0, 0), 4));
		tabbedPane.addTab("METHOD", null, panel_1, null);
		...
		btnNewButton_1.setIcon(new ImageIcon(MainView.class.getResource("/images/eat-here.jpg")));
		...
		btnNewButton_1_1.setIcon(new ImageIcon(MainView.class.getResource("/images/take-away.jpg")));
		...
		lblNewLabel_2.setFont(new Font("Segoe Script", Font.BOLD, 30));
		lblNewLabel_2.setBounds(259, 35, 168, 42);
		...
		panel_5.setBorder(new TitledBorder(new EtchedBorder(EtchedBorder.LOWERED, new Color(255, 255, 255), new Color(160, 160, 160)), "  Chicken", TitledBorder.CENTER, TitledBorder.TOP, null, new Color(0, 0, 0)));
		...
		mcChicken.setIcon(new ImageIcon(MainView.class.getResource("/images/mc chicken.png")));
		
		JPanel panel_9 = new JPanel();
		panel_9.setFont(new Font("Tahoma", Font.PLAIN, 12));
		panel_9.setBorder(new TitledBorder(new EtchedBorder(EtchedBorder.LOWERED, new Color(255, 255, 255), new Color(160, 160, 160)), "Ayam   2pcs", TitledBorder.CENTER, TitledBorder.TOP, null, new Color(0, 0, 0)));
		...
		ayamMcd2pc.setIcon(new ImageIcon(MainView.class.getResource("/images/ayam mcd 2pc.png")));
		
		JPanel panel_10 = new JPanel();
		panel_10.setBorder(new TitledBorder(new EtchedBorder(EtchedBorder.LOWERED, new Color(255, 255, 255), new Color(160, 160, 160)), "Ayam   5pcs", TitledBorder.CENTER, TitledBorder.TOP, null, new Color(0, 0, 0)));
		...
		ayamMcd5pc.setIcon(new ImageIcon(MainView.class.getResource("/images/ayam mcd 5pc.png")));
		...
		spicyChicDeluxe.setIcon(new ImageIcon(MainView.class.getResource("/images/spicy chic deluxe.png")));
		
		JPanel panel_16 = new JPanel();
		panel_16.setBorder(new TitledBorder(new EtchedBorder(EtchedBorder.LOWERED, new Color(255, 255, 255), new Color(160, 160, 160)), "  Nugget 6pcs", TitledBorder.CENTER, TitledBorder.TOP, null, new Color(0, 0, 0)));
		...
		nugget.setIcon(new ImageIcon(MainView.class.getResource("/images/nugget.jfif.png")));
		...
		doubleCheeseBurger.setIcon(new ImageIcon(MainView.class.getResource("/images/product-double-cheeseburger.png")));
		...
		bigMac.setIcon(new ImageIcon(MainView.class.getResource("/images/product-big-mac.png")));
		...
		filetOFish.setIcon(new ImageIcon(MainView.class.getResource("/images/filet-o-fish.png")));
		
		JPanel panel_12 = new JPanel();
		panel_12.setBorder(new TitledBorder(new EtchedBorder(EtchedBorder.LOWERED, new Color(255, 255, 255), new Color(160, 160, 160)), "  Chicken Meal", TitledBorder.CENTER, TitledBorder.TOP, null, new Color(0, 0, 0)));
		...
		mcChickenMeal.setIcon(new ImageIcon(MainView.class.getResource("/images/mc chcken meal.png")));
		
		JPanel panel_13 = new JPanel();
		panel_13.setBorder(new TitledBorder(new EtchedBorder(EtchedBorder.LOWERED, new Color(255, 255, 255), new Color(160, 160, 160)), "  Nugget 6pcs", TitledBorder.CENTER, TitledBorder.TOP, null, new Color(0, 0, 0)));
		...
		chickenMcnuggets.setIcon(new ImageIcon(MainView.class.getResource("/images/mcd-meals-chicken-mcnuggets.png")));
		...
		fofMeal.setIcon(new ImageIcon(MainView.class.getResource("/images/fof meal.png")));
		...
		strawberrySundae.setIcon(new ImageIcon(MainView.class.getResource("/images/product-strawberry-sundae.png")));
		...
		hotFudgeSundae.setIcon(new ImageIcon(MainView.class.getResource("/images/product-hot-fudge-sundae.png")));
		...
		al.setIcon(new ImageIcon(MainView.class.getResource("/images/filet-o-fish.png")));
		ap.add(al);
		...
		al4.setIcon(new ImageIcon(MainView.class.getResource("/images/ayam mcd 2pc.png")));
		ap2.add(al4);
		...
		al7.setIcon(new ImageIcon(MainView.class.getResource("/images/ayam mcd 5pc.png")));
		ap3.add(al7);
		
		JLabel al8 = new JLabel("Ayam  5pcs");
		...
		al10.setIcon(new ImageIcon(MainView.class.getResource("/images/fof meal.png")));
		ap4.add(al10);
		...
		al13.setIcon(new ImageIcon(MainView.class.getResource("/images/mc chcken meal.png")));
		ap5.add(al13);
		
		JLabel al14 = new JLabel("Chicken Meal");
		...
		al16.setIcon(new ImageIcon(MainView.class.getResource("/images/mc chicken.png")));
		ap6.add(al16);
		
		JLabel al17 = new JLabel("Chicken");
		...
		al19.setIcon(new ImageIcon(MainView.class.getResource("/images/mcd-meals-chicken-mcnuggets.png")));
		ap7.add(al19);
		...
		al22.setIcon(new ImageIcon(MainView.class.getResource("/images/nugget.jfif.png")));
		ap8.add(al22);
		...
		al25.setIcon(new ImageIcon(MainView.class.getResource("/images/product-big-mac.png")));
		ap9.add(al25);
		...
		al28.setIcon(new ImageIcon(MainView.class.getResource("/images/product-double-cheeseburger.png")));
		ap10.add(al28);
		...
		al31.setIcon(new ImageIcon(MainView.class.getResource("/images/product-hot-fudge-sundae.png")));
		ap11.add(al31);
		...
		al34.setIcon(new ImageIcon(MainView.class.getResource("/images/product-strawberry-sundae.png")));
		ap12.add(al34);
		...
		al37.setIcon(new ImageIcon(MainView.class.getResource("/images/spicy chic deluxe.png")));
		ap13.add(al37);
		
		JLabel al38 = new JLabel("Spicy Deluxe");
		...
		btnNewButton_6.setBounds(213, 365, 193, 37);
		...
		btnNewButton_6_1.setBounds(10, 365, 193, 37);
		...
		lblNewLabel_5.setBounds(411, 230, 270, 31);
		panel_4.add(lblNewLabel_5);
		
		JPanel panel_8 = new JPanel();
		panel_8.setBorder(new LineBorder(new Color(0, 0, 0), 3));
		panel_8.setBackground(Color.WHITE);
		panel_8.setBounds(489, 272, 192, 43);
		panel_4.add(panel_8);
		...
		lblNewLabel_6.setBounds(411, 11, 270, 36);
		...
		txtCreditCardNumber.setBounds(411, 90, 270, 31);
		...
		lblNewLabel_7.setBounds(411, 58, 270, 21);
		...
		btnNewButton_15.setBounds(411, 132, 121, 21);
	...
	public void setOrderedItems() throws SQLException {
		for(int i = 0 ;i<choosedItem.length;i++) {
			if(choosedItem[i]) {
				...
				orderedItem.setItem(itemProductDatabase.getItem(i+1));
